...
#     # Check if the credentials are valid, otherwise launch user consent window
#     if not creds.valid:
#         typer.echo("Credentials are not valid. Launching user consent window...")
#         auth_url = creds.get_authorization_url()
#         typer.launch(auth_url)

#         # After user consent, retrieve token
#         auth_code = typer.prompt("Enter the authorization code:")
#         creds = creds.fetch_token(auth_code)
