...
DEFAULT_DIRS = ["cellveyor", "tests", "scripts"]
...
def _scan_files(
    ...
    default directories cellveyor/, tests/, scripts/),
...
def check(
    paths: list[Path] | None = typer.Argument(
        None,
        help="Paths to scan. Defaults to cellveyor/, tests/, and scripts/.",
    ),
) -> None:
...
def fix(
    paths: list[Path] | None = typer.Argument(
        None,
        help="Paths to fix. Defaults to cellveyor/, tests/, and scripts/.",
    ),
) -> None:
